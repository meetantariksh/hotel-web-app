...
import MontserratRegular from './externals/fonts/montserrat/Montserrat-Regular.ttf';
import MontserratBold from './externals/fonts/montserrat/Montserrat-Bold.ttf';
import CourgetteRegular from './externals/fonts/courgette/Courgette-Regular.ttf';
import PoppinsRegular from './externals/fonts/poppins/Poppins-Regular.ttf';
import PoppinsMedium from './externals/fonts/poppins/Poppins-Medium.ttf';
import PoppinsBold from './externals/fonts/poppins/Poppins-Bold.ttf';
import PoppinsLight from './externals/fonts/poppins/Poppins-Light.ttf';
import NotoSansRegular from './externals/fonts/notosans/NotoSans-Regular.ttf';

import pattern1 from './externals/images/icons/pattern1.png';
import pattern2 from './externals/images/icons/pattern2.png';
import pattern3 from './externals/images/icons/pattern3.png';

import close from './externals/vendor/lightbox2/images/close.png';
import loading from './externals/vendor/lightbox2/images/loading.gif';
import prev from './externals/vendor/lightbox2/images/prev.png';
import next from './externals/vendor/lightbox2/images/next.png';
...
body:after {
	content: url(${close}) url(${loading}) url(${prev}) url(${next});
	display: none;
  }
